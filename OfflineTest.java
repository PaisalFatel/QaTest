...
public class OfflineExercises {
	...
	public String doubleChar(String msg) {
		String word = "";
		
		int i = 0; 

		while (i<=msg.length()){
			if (msg.substring(i,i+1).equals(i)){
	...
	public String getSandwich(String msg2) {
	String word = "";
		
		int i = 0; 

		while (i<=msg2.length()){
			if (msg2.substring(i,i+1).equals(msg2.length())){
				System.out.println(word);
				word = "";
				...
				word = msg2.substring(i,i+1) + word;
			}
